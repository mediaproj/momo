...
class SliderMainPagerAdapter(fm: FragmentManager, val num_fragment: Int): FragmentStatePagerAdapter(fm,FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT){
...
//            2-> bundle.putString("background_url", "https://scontent-icn1-1.xx.fbcdn.net/v/t1.0-9/57484969_1714122525401292_2191765538210840576_o.jpg?_nc_cat=109&_nc_ht=scontent-icn1-1.xx&oh=cdefea1b7b9c21f74652ad3684d3e723&oe=5D6B2C6D")
            0-> bundle.putString("background_url", "https://i.ytimg.com/vi/eSEs4B4H-EA/maxresdefault.jpg")
            1-> bundle.putString("background_url", "https://i.ytimg.com/vi/eSEs4B4H-EA/maxresdefault.jpg")
            2-> bundle.putString("background_url", "https://i.ytimg.com/vi/eSEs4B4H-EA/maxresdefault.jpg")
        }
